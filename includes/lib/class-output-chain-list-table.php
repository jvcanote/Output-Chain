 ...
 * @access private
 *
 * @package Output_Chain
 * @subpackage List_Table
 */
class Output_Chain_List_Table {
	 ...
	 * @uses Output_Chain_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
...
<?php
	...
	public function get_columns() {
		die( 'function Output_Chain_List_Table::get_columns() must be over-ridden in a sub-class.' );
	}
